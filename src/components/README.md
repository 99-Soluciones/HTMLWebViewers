...
Este proyecto contiene una colección de componentes HTML, CSS y JavaScript diseñados para integración con FileMaker.
...
Cada módulo es una aplicación web independiente (HTML, CSS, JS) que puede ser incrustada o utilizada en un entorno de FileMaker WebViewer. Para utilizar un componente, abra el archivo `*nombreDelProyexto*.html` o el archivo HTML principal dentro de la carpeta del módulo correspondiente.
